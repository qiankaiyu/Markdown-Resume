 ...
 - 男
 - 求职意向：全栈开发工程师（Java+React）， DevOps工程师，云原生微服务架构师
 - 工作经验：10 年
 - 期望薪资：25k+
 - 期望城市：深圳、上海
...
- **科比特航空 公司，软件研发 部门，技术主管，2021.5~2024.3**
...
- **城市之鹰**
  ...
  *Docker、Prometheus、Grafana、jMeter、EFK*
  ...
  + 2、性能优化：针对QPS低、响应时间慢、系统错误率高等情况，提供解决方案，包括
...
- **天目将PAAS平台**
  ...
  *阿里云ACK、EFK、UiPath*
  ...
  + 5、Statistic微服务开发：为实现平台的数据大屏，独立负责统计服务的开发，通过RabbitMQ+EDA架构实现统计数据的近实时更新
  + 6、UiPath实现网页端自动化测试：为了加快版本发布频率，减少回归测试耗时，采用RPA工具UiPath对网页端功能进行自动化测试，减少了测试人员的工作内容
...
- 基本掌握网页和小程序自动化测试必备技能，提高回归测试效率，拥有一年自动化测试实战经验
